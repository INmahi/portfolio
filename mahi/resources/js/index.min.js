...
(function() {
    ...
    function init() {
        ...
        lft = document.querySelectorAll(".animateEliment-left")
    ...
    function checkPosition() {
      ...
      for (var i = 0; i < lft.length; i++) {
        var onelm = lft[i];
        var positionFromTop = lft[i].getBoundingClientRect().top;
        
  
        if (positionFromTop - windowHeight <= -20) {
          onelm.classList.add('animate__animated','animate__fadeInRight');
          onelm.classList.remove('hidden');//does nothing
        }
      }
    }
