function runPreloader() {
    (document.body.style.background = "#c7c7c7bd"),
        ...
        setTimeout(() => {
            (getPopUp.style.display = "block"), (getPopUp.style.display = "block") && getWebContent.classList.add("allwrap");
        }, 6e3);
}
function closeNave() {
...
$(document).ready(function () {
    $(".track-2nd-section").waypoint(function (e) {
        "down" == e ? $("#get_nav").addClass("sticky") : $("#get_nav").removeClass("sticky");
    });
    mixitup(".services_container");
});
var getPopUp = document.getElementById("popup"),
    getDoneBtn = document.getElementById("done_btn"),
    getWebContent = document.getElementById("web_content"),
...
(getPopUp = document.getElementById("popup")), (getDoneBtn = document.getElementById("done_btn"));
